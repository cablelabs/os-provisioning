...
<div
    ...
    data-custom-abilities='@json($customAbilities, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT)'
    data-role-abilities='@json($roleAbilities, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT)'
    ...
    data-capabilities='@json($capabilities, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT)'
    data-model-abilities='@json($modelAbilities, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT)'
                        ...
                        <span class="h-8">
                            <button class="mx-1 btn btn-sm d-none d-md-block"
                                ...
                                <i class="fa {!! $action['icon'] !!} fa-lg"
                                    :class="[permissions.{!! $action['name'] !!}.{!! $module !!} ? '' : 'text-dark']"></i>
                                </span>
