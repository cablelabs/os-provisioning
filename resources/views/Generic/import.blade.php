            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route($route_name.'.import_parse') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12 col-md-offset-4">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="observer" onclick="return false;"><font color=grey> Run with observers? (deactivated)</font>
                                        </label>
                                    </div>
                                </div>
                            </div>
