         ...
         <li class="nav-header">Networks</li>
          ...
          @foreach ($networks as $network)
            <li id="network_{{$network->id}}" class="has-sub" data-sidebar="level1">
              ...
              <ul class="sub-menu">
                <li id="{{$network->name}}" class="has-sub" data-sidebar="level2"><a href="{{BaseRoute::get_base_url()}}/Tree/erd/net/{{$network->id}}"><i class="fa fa-circle text-success"></i><b class="caret ml-auto"></b> {{$network->name}}</a></li>
