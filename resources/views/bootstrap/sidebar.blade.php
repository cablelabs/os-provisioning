          ...
          <div>
              <div class="flex flex-col items-center justify-center space-y-2 border-b border-gray-200 text-xs text-center">
                  ...
                  <div class="flex flex-col items-center hover:bg-zinc-900 hover:text-lime-600 hover:cursor-pointer transition duration-150 ease-out hover:ease-in w-full p-2">
                      <svg version="1.1" viewBox="0 0 96 96" class="h-12 w-12" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                          <rect x="20" y="43.79" rx="2" ry="2" width="10" height="10" stroke="none" stroke-width="1" fill="currentColor" fill-opacity="1"/><rect x="34" y="40.79" rx="2" ry="2" width="16" height="16" stroke="none" stroke-width="1" fill="currentColor" fill-opacity="1"/><rect x="54" y="37.79" rx="2" ry="2" width="22" height="22" stroke="none" stroke-width="1" fill="currentColor" fill-opacity="1"/>
                      </svg>
                      <div>Activity</div>
                  </div>
                  <div class="flex flex-col items-center hover:bg-zinc-900 hover:text-lime-600 hover:cursor-pointer transition duration-150 ease-out hover:ease-in w-full p-2">
          ...
          <ul class="overflow-y-auto" data-scrollbar="true" data-height="100%">
            ...
            @if(Module::collections()->has('HfcBase') && auth()->user()->can('view', Modules\HfcBase\Entities\TreeErd::class))
              ...
              <template v-if="isVisible">
                ...
                <li v-if="Object.keys(loopNetElements).length === 0 && !isSearchMode && !minified && !netCount" class="m-l-20 m-t-10 text-light w-75">{{ trans('messages.noNetElement')}}</li>
