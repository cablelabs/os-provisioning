<div v-cloak id="sidebar-right" class="fixed h-full right-0 z-[1010] flex text-gray-100">
    <div class="relative w-64 mt-12 transition-all duration-200 bg-sidebar-dark"
        ...
        <div class="absolute flex flex-col items-center w-5 h-full pt-2 space-y-4 -left-5 bg-lime-nmsprime">
            ...
            <div v-if="!store.minifiedRight" class="hover:cursor-pointer" v-on:click="pinSidebarRight">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 duration-300 ease-in-out" :class="{ 'block rotate-90': pinned, 'block -rotate-90 hover:rotate-0': !pinned }" fill="currentColor" viewBox="0 0 384 512"
        ...
        <div v-cloak class="p-2 overflow-scroll">
            <div>
                <b>Details</b>
            </div>
