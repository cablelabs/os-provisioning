...
return [
    ...
    */
    ...
    'mail_not_sent'             => 'Email could not be delivered',
    'mail_env'                  => ' - Missing email data in environment file!',
    'mail_conf'                 => ' - The NoReply-Name and the NoReply-Email must be set in the ticketsystem config!',
    'mail_user'                 => ' - The profile of the recipient has no email set!',
    'mail_salutation'           => 'This is an automated Mail from the Ticketsystem of NMS Prime.',
