...
return [
  ...
  */
    ...
    'Modem_SupportState_full-support' => 'This means that the modem is listed as a supported device on NMSPRIME.',
    'Modem_SupportState_not-supported' => 'This means that the modem is not listed as a supported device on NMSPRIME.',
    'Modem_SupportState_verifying' => 'This means that the modem is not yet found as a supported device on NMSPRIME, but still within a verification period of 6 weeks.',
    'Cmts_SupportState_full-support' => 'This means that the more than 95% of cmts modules are listed as supported devices on NMSPRIME.',
    'Cmts_SupportState_restricted' => 'This means that 80%-95% of cmts modules are listed as supported devices on NMSPRIME.',
    'Cmts_SupportState_not-supported' => 'This means that less than 80% of cmts modules are listed as supported devices on NMSPRIME.',
    'Cmts_SupportState_verifying' => 'This means that the less than 80% of cmts modules are not not yet listed as supported device on NMSPRIME, but still within a verification period of 6 weeks',
