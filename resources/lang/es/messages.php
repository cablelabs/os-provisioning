...
return [
    ...
    */
    ...
    'snmp' => [
        ...
        'wsConFail' => 'The connection to the websocket server could not be established. Please check if the server runs and is configured correctly or try to enable it in your browser once via: ',
    ],
    'State'                     => 'Estado',
    'Street'                    => 'Calle',
    'Typee'                     => 'Tipo',
