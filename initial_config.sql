...
INSERT INTO phonetariff (created_at, external_identifier, name, type, description, usable) VALUES (NOW(), 'VOIP0413_ERZ_standard', 'Telefonie Basic (EnviaTel)', 'sale', 'Telefonie Basic via EnviaTel', 1);
INSERT INTO phonetariff (created_at, external_identifier, name, type, description, usable) VALUES (NOW(), 'VOIP0413_ERZ_flat', 'Telefonie Flat (EnviaTel)', 'sale', 'Telefonie Flat via EnviaTel', 1);
