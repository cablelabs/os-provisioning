...
return [
    ...
    */
    ...
    'document_type' => [
        ...
        'missing_contract_end_and_items_cancelation_date' => 'Es ist mindestens eine Beendigung eines Postens oder das Setzen des Vertragsendes erforderlich.',
    ...
    'values' => [
        'status' => [
            'active_in_the_future' => 'zukünftig aktiv',
    ...
    */
    ...
    'net'                  => 'Bitte geben Sie die Netzadresse (erste mögliche IP des Bereiches) mit Netzmaske im CIDR Format an.',
    ...
    */
    ...
    'attributes' => [
        ...
        'gender' => 'Geschlecht',
        'hour' => 'Stunde',
        'infrastructure_file_upload' => 'Infrastruktur-Datei',
        'last_name' => 'Nachname',
        'lastname' => 'Nachname',
        'minute' => 'Minute',
        'mobile' => 'Handynummer',
