...
sudo -u postgres /usr/pgsql-13/bin/psql -d nmsprime < /var/www/nmsprime/Install/files/nmsprime.pgsql
sudo -u postgres /usr/pgsql-13/bin/psql < /etc/raddb/mods-config/sql/ippool/postgresql/schema.sql
