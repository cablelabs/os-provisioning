...
class TRCClassDatabaseUpdaterCommand extends Command {
	...
	/**
	 * Updating trc classs via Envia API means a simple call of the method in ProvVoipEnvia
	...
	protected function _update_using_envia_api() {
		...
		$url_suffix = \URL::route("ProvVoipEnvia.cron", array('job' => 'misc_get_keys', 'keyname' => 'trc_class', 'really' => 'True'), false);
