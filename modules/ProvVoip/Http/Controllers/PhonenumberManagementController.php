...
class PhonenumberManagementController extends \BaseController {
	...
	public function view_form_fields($model = null)
	{
		...
		$ret_tmp = array(
			...
			array('form_type' => 'select', 'name' => 'carrier_out', 'description' => 'Carrier out', 'value' => CarrierCode::carrier_list_for_form_select(True), 'checkbox' => 'show_on_porting_out', 'space' => '1'),
			array('form_type' => 'checkbox', 'name' => 'autogenerated', 'description' => 'Automatically generated', 'help' => trans('helper.PhonenumberManagement_Autogenerated'), 'hidden' => $hide_flags['autogenerated']),
		);
