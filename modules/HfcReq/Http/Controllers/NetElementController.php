...
class NetElementController extends BaseController
{
    ...
    public function view_form_fields($netelement = null)
    {
        ...
        $a = [
            ...
            ['form_type' => 'select', 'name' => 'prov_device_id', 'description' => 'Provisioning Device', 'value' => $this->setupSelect2Field($netelement, 'Custom', 'prov_device_id', 'provDevice'), 'hidden' => $prov_device_hidden, 'options' => ['class' => 'select2-ajax', 'data-allow-clear' => 'true', 'data-placeholder' => trans('view.select.base', ['model' => trans('view.select.Parent')]), 'ajax-route' => route('NetElement.select2', ['base_type' => $type, 'relation' => 'provDevice'])]],
