<!-- attach button -->
<div class='col-md-6'>
	{{ Form::open(['route' => ['DeviceType.assign', $view_var->id], 'method' => 'get']) }}
...
<!-- detach all button -->
<div class='col-md-6'>
	{{ Form::open(['route' => ['DeviceType.detach_all', $view_var->id], 'method' => 'delete']) }}
...
{{ Form::open(array('route' => array('DeviceType.detach_oid', $view_var->id), 'method' => 'delete')) }}
