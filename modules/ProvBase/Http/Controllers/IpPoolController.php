...
class IpPoolController extends \BaseController {
	...
	public function view_form_fields($model = null)
	{
		...
		if (!$model->exists)
		{
			...
			if ($ippools->count()>0)
			{
			...
			else switch ($type) { // if not: add default net, depending on type
				...
				case 'MTA':     $next_net = env('IP_MTA_DEFAULT_NET', '172.17.0.0'); $init_values['dns1_ip'] = \ProvBase::first()->provisioning_server;	break;
