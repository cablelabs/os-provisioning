...
class BaseController extends Controller
{
     ...
     * @param sortsearch array like ['customcolumn' => ['order' => 'false', 'search' => 'false']] disables sorting & searching for the chosen column (e.g. when it is impossible) => prevent errors
