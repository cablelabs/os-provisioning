...
if (! function_exists('snmpWrapper')) {
    /**
...
if (! function_exists('escape_latex_special_chars')) {
    /**
...
if (! function_exists('concat_pdfs')) {
    /**
...
if (! function_exists('pdflatex_error_msg')) {
    /**
...
if (! function_exists('number_format_lang')) {
    /**
...
if (! function_exists('whereLaterOrEqual')) {
    /**
...
if (! function_exists('clearFailedJobs')) {
    /**
...
if (! function_exists('langDateFormat')) {
    /**
...
if (! function_exists('distanceLatLong')) {
    /**
...
if (! function_exists('getSyslogEntries')) {
    /**
     * Helper to get Syslog entries dependent on what should be searched and discarded
     *
...
if (! function_exists('isMobileRegEx')) {
    function isMobileRegEx(int $check): string
    {
        if ($check == 1) {
            return '/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i';
...
if (! function_exists('valueInThresholdString')) {
    /**
...
if (! function_exists('valuesFromThresholdString')) {
    /**
     * @param  string  $thresholds  someting like “..10” or “-1.5..1.5” or “-20..-10;10..20”
...
if (! function_exists('waitForLogFileToStopGrowing')) {
    /**
...
if (! function_exists('snmpDateAndTimeToCarbon')) {
...
if (! function_exists('snmpIpAddrToInet')) {
...
if (! function_exists('sysUpTimeForHumans')) {
    /**
...
if (! function_exists('bitsForHumans')) {
    /**
...
if (! function_exists('serverSentEventResponse')) {
    /**
     * Generic function to return data retrieved by the specified callback for a server sent event resource
     *
     * @author Nino Ryschawy
     */
    function serverSentEventResponse(callable $callback)
    {
